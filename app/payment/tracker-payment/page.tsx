...
import { getUserPayments } from '../../apis/payment'; // Assuming this function gets all payments, including tracker payments
        ...
        <Box mx="20px" my="12px" py="20px">
          <Flex justifyContent="space-between" mb="10px" alignContent="center">
            ...
            <Button
              ...
              color="white"
              as="a"
              href="/payment/tracker-payment/pay"
              _hover={{
                opacity: 0.8,
              }}
            >
    ...
    <Flex justifyContent="center" alignItems="center">
      <Box bgColor="white" width="400px" p="60px" textAlign="center" mt="40px">
        ...
        <Text color="#323232" fontWeight="400" fontSize="18px">
          All Tracker Payments will be listed in this page
        </Text>
        <Link href="/payment/tracker-payment/pay" prefetch={true}>
          <Button
            as="a"
            mt="50px"
            height="56px"
