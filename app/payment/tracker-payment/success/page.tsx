...
import { verifyTrackerPayment } from "@/app/apis/payment";
...
export default function PaymentSuccessful() {
  ...
  const tractor_id = params.get("tractor_id");
  ...
  const handleVerification = async () => {
    ...
    console.log({
      reference, userToken
        ...
        const response = await verifyTrackerPayment(tractor_id, reference, userToken);
