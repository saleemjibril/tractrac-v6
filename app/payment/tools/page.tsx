...
import { getUserAgroToolPayments } from "../../apis/payment";
...
export default function Payments() {
  ...
  const handleGetUserPayments = async () => {
    ...
    try {
      ...
      console.log("getUserAgroToolPayments", response);
  ...
  return (
    <Flex justifyContent="center" alignItems="center">
      <Box bgColor="white" width="400px" p="60px" textAlign="center" mt="40px">
        ...
        <Link href="/payment/tools/pay" prefetch={true}>
          <Button
            as="a"
            mt="50px"
            height="56px"
