...
export default function TermsAndConditionsInner() {
    ...
    <ChakraWrapper>
      <Box position={"relative"}>
        ...
        >
          ...
          <Text color="#858A8F" fontSize="16px" mb="20px">
          ...
          <Box mb="30px">
            <Text color="#858A8F" fontSize="16px" lineHeight="1.6">
              <strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.
              <br/><br/>
              <strong>Country</strong> refers to: Nigeria
              <br/><br/>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Tractrac Mechanization Service Limited, 11 Vanern St, Wuse, Abuja 904101, Federal Capital Territory.
              <br/><br/>
              ...
              <br/><br/>
              <strong>Website</strong> refers to Tractrac Msl, accessible from tractrac.co
              <br/><br/>
          ...
          <Text color="#858A8F" fontSize="16px" textAlign="center" mb="50px" lineHeight="1.6">
            If you have any questions about these Terms and Conditions, You can contact us:
            <br/><br/>
            By email: <Link href={"mailto:info@tractrac.co"} style={{color:"#FA9411"}}>info@tractrac.co</Link>
            <br/><br/>
            By visiting this page on our website: <Link href="/contact" prefetch={true} style={{color:"#FA9411"}}>https://tractrac.co/contact</Link>
            <br/><br/>
            By phone number: +2348064648720
          </Text>
        </Box>
