        ...
        >
          ...
          <Box mb="30px">
            <Text color="#858A8F" fontSize="16px" lineHeight="1.6">
              ...
              <br/><br/>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Tractrac Msl, 11 Vanern Crescent, Wuse, FCT 904101, Federal Capital Territory.
              <br/><br/>
              ...
              <br/><br/>
              <strong>Website</strong> refers to Tractrac Msl, accessible from https://tractrac.co/
              <br/><br/>
          ...
          <Text fontWeight={600} fontSize="16px" mb="10px" color="#333">
            Personal Data
          </Text>
          <Text color="#858A8F" fontSize="16px" mb="20px" lineHeight="1.6">
