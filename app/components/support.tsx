...
import { createSupportTicket, getUserSupportTicketDetails, getUserSupportTickets, sendSupportTicketMessage } from "../apis/support";
...
export default function SupportWidget() {
  ...
  const handleSystemEvent = useCallback((message: MessageModel, profileId: string) => {
  ...
  return (
    ...
    <div className="support">
      {bubbleOpen ? <div className="support__bubble"
      onClick={() => {
        setBubbleOpen(false)
        setOpen(true)
      }}
...
<>
      ...
      {stage === 1 && (
        <div className={open ? "support__inner" : "support__inner support__inner-short"}>
          <div className="support__inner__header"
      ...
      {stage === 2 && (
        <div className={open ? "support__inner" : "support__inner support__inner-short"}>
          ...
          <div className="support__inner__card" onClick={() => setSelectedTicketId(ticket?.id)}>
          <div className="support__inner__card__group">
            <div className="support__inner__card__initials">SJ</div>

            <div>
              <div className="support__inner__card__message">{ticket?.last_message?.content?.substring(0, 20)}...</div>
              <div className="support__inner__card__flex">
                <div className="support__inner__card__who">Support Agent</div>
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                ...
                <div className="support__inner__card__time">{moment(ticket?.last_message?.created_at).fromNow()}</div>
              </div>
            </div>
          </div>
          ...
          {open && <div className="support__inner__new"
          onClick={() => setStage(1)}
          >
            <svg
              fill="#fff"
      ...
      {stage === 3 && (
        <div className={open ? "support__chat" : "support__chat support__inner-short"}>
          <div className={"support__chat__header"}
                    onClick={() => setStage(2)}
          ...
          <div className="support__chat__inner">
           {[...messages]?.reverse()?.map((message) => (
            <div className={message?.sender_id !== profileInfo?.id ? "support__chat__inner__chat support__chat__inner__received" : "support__chat__inner__chat support__chat__inner__sent"}>
              <div className="support__chat__inner__received__inner">
                {message?.content}
                <div className="support__chat__inner__chat__time">{moment(message?.created_at).fromNow()}</div>
              </div>
            </div>
           )) }
          ...
          <div className="support__chat__input">
            ...
            <div className="support__chat__input__send"
